"""W1-2 Continuation / Follow-Through — WAVE-0 stub."""
...
def evaluate_w1_2(*, fas: FamilyAssessmentSetV1, binding: FASBinding) -> Wave0EvalOutcome:
    return wave0_stub_evaluate(wave1_target=Wave1Target.W1_2, fas=fas, binding=binding)
