"""W1-1 Liquidity Event → Reclaim / Return — WAVE-0 stub."""
...
def evaluate_w1_1(*, fas: FamilyAssessmentSetV1, binding: FASBinding) -> Wave0EvalOutcome:
    return wave0_stub_evaluate(wave1_target=Wave1Target.W1_1, fas=fas, binding=binding)
