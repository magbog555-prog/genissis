# Thinking family knowledge dossier — Breakout

**File:** `04_thinking_families/03_breakout.md`  
**family_id:** `breakout`  
...
## 1. Cognitive purpose
Organize market questions for **Breakout** when family analysis may be available.
...
- `KC-BREAKOUT-DOCTRINE` — Breakout doctrine (crowd=VERY_HIGH)
...
Queued in `research_hypotheses.json` with `related_families` containing `breakout`.
