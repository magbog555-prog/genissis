# Thinking family knowledge dossier — Reversal

**File:** `04_thinking_families/02_reversal.md`  
**family_id:** `reversal`  
...
## 1. Cognitive purpose
Organize market questions for **Reversal** when family analysis may be available.
...
- `KC-ABSORPTION` — Absorption (crowd=MEDIUM)
...
Queued in `research_hypotheses.json` with `related_families` containing `reversal`.
